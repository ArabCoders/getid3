...
namespace arabcoders\getid3\Tests\Write;

use arabcoders\getid3\GetId3Core;
use arabcoders\getid3\Write\Tags;
...
class AudioTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        self::$class       = GetId3Core::class;
        self::$classWriter = Tags::class;
    }
    ...
    public function testWriteId3Tags()
    {
        ...
        $tagData             = [
            'title'   => [ 'My Song' . $hash ],
            'artist'  => [ 'The Artist' . $hash ],
            'album'   => [ 'Greatest Hits' . $hash ],
            'year'    => [ '1986' . $hash ],
            'genre'   => [ 'Electronic' . $hash ],
            'comment' => [ 'excellent!' . $hash ],
            'track'   => [ '04/16' . $hash ],
        ];
