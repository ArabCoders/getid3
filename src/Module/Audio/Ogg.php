 ...
 */
class Ogg extends BaseHandler implements ModuleInterface
{
    /**
     * @var bool
     */
            ...
            elseif ( strstr( $commentstring, '=' ) )
            {
                ...
                else
                {
                    do
                    {
                        ...
                        {
                            $info['ogg']['comments']['picture'][] = [ 'data' => $ThisFileInfo_ogg_comments_raw[$i]['data'], 'image_mime' => $ThisFileInfo_ogg_comments_raw[$i]['image_mime'] ];
                        }
                    }
                    while ( false );
                }
