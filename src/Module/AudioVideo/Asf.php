                          ...
                          ++$ExtendedContentDescriptorsCounter )
                    {
                        ...
                        switch ( self::TrimConvert( strtolower( $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['name'] ) ) )
                        {
                            ...
                            case 'artist':
                                ...
                                $thisfile_asf_comments['albumartist'] = [ self::TrimTerm( $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value'] ) ];
                                break;

                            case 'wm/albumtitle':
                            case 'album':
                                $thisfile_asf_comments['album'] = [ self::TrimTerm( $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value'] ) ];
                                break;

                            case 'wm/genre':
                            case 'genre':
                                $thisfile_asf_comments['genre'] = [ self::TrimTerm( $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value'] ) ];
                                break;

                            case 'wm/partofset':
                                $thisfile_asf_comments['partofset'] = [ self::TrimTerm( $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value'] ) ];
                                break;

                            case 'wm/tracknumber':
                            case 'tracknumber':
                                // be careful casting to int: casting unicode strings to int gives unexpected results (stops parsing at first non-numeric character)
                                $thisfile_asf_comments['track'] = [ self::TrimTerm( $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value'] ) ];
                            ...
                            case 'wm/track':
                                ...
                                {
                                    $thisfile_asf_comments['track'] = [ 1 + self::TrimConvert( $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value'] ) ];
                                }
                                break;
                            ...
                            case 'year':
                            case 'date':
                                $thisfile_asf_comments['year'] = [ self::TrimTerm( $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value'] ) ];
                                break;

                            case 'wm/lyrics':
                            case 'lyrics':
                                $thisfile_asf_comments['lyrics'] = [ self::TrimTerm( $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value'] ) ];
                                break;
                                    ...
                                    case 0: // Unicode string
                                        ...
                                        )
                                        {
                                            $thisfile_asf_comments[str_replace( 'wm/',
                                                                                '',
                                                                                strtolower( self::TrimConvert( $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['name'] ) ) )] = [ self::TrimTerm( $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value'] ) ];
                                        }
                                        break;
