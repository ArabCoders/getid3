...
class Mpeg extends BaseHandler
{
    ...
    {
        $MPEGvideoFramerateLookup = [ 0, 23.976, 24, 25, 29.97, 30, 50, 59.94, 60 ];
    ...
    {
        $MPEGvideoAspectRatioLookup = [ 0, 1, 0.6735, 0.7031, 0.7615, 0.8055, 0.8437, 0.8935, 0.9157, 0.9815, 1.0255, 1.0695, 1.0950, 1.1575, 1.2015, 0 ];
    ...
    {
        $MPEGvideoAspectRatioTextLookup = [ 'forbidden', 'square pixels', '0.6735', '16:9, 625 line, PAL', '0.7615', '0.8055', '16:9, 525 line, NTSC', '0.8935', '4:3, 625 line, PAL, CCIR601', '0.9815', '1.0255', '1.0695', '4:3, 525 line, NTSC, CCIR601', '1.1575', '1.2015', 'reserved' ];
