 ...
 *
 * @uses   \arabcoders\getid3\Write\Apetag (optional)
 * @uses   \arabcoders\getid3\Write\Id3v1 (optional)
 * @uses   \arabcoders\getid3\Write\Vorbiscomment (optional)
...
class Tags
{
        ...
        foreach ( $WritingFilesToInclude as $tagformat )
        {
            switch ( $tagformat )
            {
                case 'ape':
                    ...
                    if ( !class_exists( '\\arabcoders\\getid3\\Write\\Apetag' ) )
                    {
                        return false;
                    }
                    break;
                ...
                case 'real':
                    ...
                    if ( !class_exists( '\\arabcoders\\getid3\\Write\\' . ucfirst( $tagformat ) ) )
                    {
                        return false;
                    }
                    break;
                ...
                case 'id3v2':
                    ...
                    if ( !class_exists( '\\arabcoders\\getid3\\Write\\Id3v2' ) )
                    {
                        return false;
                    }
                    break;
    ...
    public function FormatDataForID3v1()
    {
        ...
        $tag_data_id3v1['title']   = Helper::iconv_fallback( $this->tag_encoding, 'ISO-8859-1', implode( ' ', ( isset( $this->tag_data['TITLE'] ) ? $this->tag_data['TITLE'] : [] ) ) );
        $tag_data_id3v1['artist']  = Helper::iconv_fallback( $this->tag_encoding, 'ISO-8859-1', implode( ' ', ( isset( $this->tag_data['ARTIST'] ) ? $this->tag_data['ARTIST'] : [] ) ) );
        $tag_data_id3v1['album']   = Helper::iconv_fallback( $this->tag_encoding, 'ISO-8859-1', implode( ' ', ( isset( $this->tag_data['ALBUM'] ) ? $this->tag_data['ALBUM'] : [] ) ) );
        $tag_data_id3v1['year']    = Helper::iconv_fallback( $this->tag_encoding, 'ISO-8859-1', implode( ' ', ( isset( $this->tag_data['YEAR'] ) ? $this->tag_data['YEAR'] : [] ) ) );
        $tag_data_id3v1['comment'] = Helper::iconv_fallback( $this->tag_encoding, 'ISO-8859-1', implode( ' ', ( isset( $this->tag_data['COMMENT'] ) ? $this->tag_data['COMMENT'] : [] ) ) );
        $tag_data_id3v1['track']   = intval( Helper::iconv_fallback( $this->tag_encoding, 'ISO-8859-1', implode( ' ', ( isset( $this->tag_data['TRACKNUMBER'] ) ? $this->tag_data['TRACKNUMBER'] : [] ) ) ) );
    ...
    {
        $tag_data_real['title']     = Helper::iconv_fallback( $this->tag_encoding, 'ISO-8859-1', implode( ' ', ( isset( $this->tag_data['TITLE'] ) ? $this->tag_data['TITLE'] : [] ) ) );
        $tag_data_real['artist']    = Helper::iconv_fallback( $this->tag_encoding, 'ISO-8859-1', implode( ' ', ( isset( $this->tag_data['ARTIST'] ) ? $this->tag_data['ARTIST'] : [] ) ) );
        $tag_data_real['copyright'] = Helper::iconv_fallback( $this->tag_encoding, 'ISO-8859-1', implode( ' ', ( isset( $this->tag_data['COPYRIGHT'] ) ? $this->tag_data['COPYRIGHT'] : [] ) ) );
        $tag_data_real['comment']   = Helper::iconv_fallback( $this->tag_encoding, 'ISO-8859-1', implode( ' ', ( isset( $this->tag_data['COMMENT'] ) ? $this->tag_data['COMMENT'] : [] ) ) );
